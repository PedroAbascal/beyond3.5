...
db = {
    "races": {
        ...
        "elf": {
            ...
            "description": "Inmunidad a dormir. Visión en la penumbra. +2 a Avistar, Buscar, Escuchar."
        },
        "dwarf": {
            "name": "Enano",
            "size": "Mediano",
            ...
            "description": "Visión en la oscuridad. Afinidad con la piedra. +2 en salvaciones contra venenos y magia."
        },
        "halfling": {
            "name": "Mediano",
            "size": "Pequeño",
            ...
            "description": "+1 tamaño a CA y ataque. +2 a Trepar, Saltar, Moverse Silenciosamente. +1 todas las salvaciones."
        },
        "gnome": {
            "name": "Gnomo",
            "size": "Pequeño",
            ...
            "description": "+1 tamaño a CA y ataque. Visión en la penumbra. +2 salvaciones contra ilusiones."
        },
        "half-orc": {
            "name": "Semi-orco",
            "size": "Mediano",
            ...
            "description": "Visión en la oscuridad 60 pies. Sangre orca."
        },
        "half-elf": {
            "name": "Semi-elfo",
            "size": "Mediano",
            "speed": 30,
            "statMods": { "str": 0, "dex": 0, "con": 0, "int": 0, "wis": 0, "cha": 0 },
            "description": "Inmunidad a dormir. Visión en la penumbra. +1 a Avistar, Buscar, Escuchar, Diplomacia."
        }
    },
    "classes": {
        "barbarian": {
            ...
            "features": [
                {"name": "Furia", "type": "free", "desc": "+4 Fue, +4 Con, +2 Vol, -2 CA (1/día)."},
        ...
        "bard": {
            ...
            "features": [
                {"name": "Música Bárdica", "type": "standard", "desc": "Inspirar valor, fascinar, etc. (1/día por nivel)."},
                {"name": "Conocimiento de Bardo", "type": "free", "desc": "Tirada para recordar información arcana o local."}
            ]
        },
        "cleric": {
        ...
        "druid": {
            ...
            "spellcaster": { "type": "prepared", "attr": "wis", "slotsByLevel": { "1": [3, 1], "2": [4, 2], "3": [4, 2, 1], "4": [5, 3, 2] } },
            "features": [
                {"name": "Compañero Animal", "type": "passive", "desc": "Tienes un compañero animal leal que te acompaña en combate."},
                {"name": "Empatía Salvaje", "type": "standard", "desc": "Mejora la actitud de un animal (1d20 + nivel + Cha)."},
                {"name": "Forma Salvaje", "type": "standard", "desc": "Te transformas en un animal Pequeño o Mediano (a partir de nivel 5)."}
            ]
        },
        "fighter": {
        ...
        "monk": {
            ...
            "features": [
                {"name": "Ráfaga de Golpes", "type": "full", "desc": "Ataques adicionales desarmado o con armas de monje con penalizador."},
                {"name": "Ataque Desarmado", "type": "passive", "desc": "Daño mejorado (1d6 a nivel 1) al pelear sin armas."},
                {"name": "Evasión", "type": "passive", "desc": "Si pasas salvación de Reflejos, recibes 0 daño en vez de la mitad."},
                {"name": "Puñetazo Aturdidor", "type": "standard", "desc": "Tu ataque desarmado puede aturdir (Fort CD 10 + mitad nivel + Sab)."}
            ]
        },
        "paladin": {
            ...
            "features": [
                {"name": "Castigar al Mal", "type": "free", "desc": "Añade Cha al Ataque, Nivel al Daño contra un ser maligno (1/día)."},
                {"name": "Detectar el Mal", "type": "standard", "desc": "A voluntad, como el hechizo."},
                {"name": "Imposición de Manos", "type": "standard", "desc": "Cura (Nivel x Cha) PG al día en total."},
        ...
        "ranger": {
            ...
            "features": [
                {"name": "Enemigo Predilecto", "type": "passive", "desc": "+2 a daño, engañar, escuchar, averiguar intenciones, avistar y supervivencia contra tu enemigo elegido."},
                {"name": "Empatía Salvaje", "type": "standard", "desc": "Mejora actitud de un animal salvaje."},
        ...
        "sorcerer": {
            ...
            "features": [
                {"name": "Invocar Familiar", "type": "standard", "desc": "Obtienes un familiar mágico que te otorga bonos pasivos."}
            ]
        },
        "wizard": {
    ...
    "skills": [
        ...
        { "id": "artesania", "name": "Artesanía", "attr": "int" },
        ...
        { "id": "concentracion", "name": "Concentración", "attr": "con" },
        ...
        { "id": "engañar", "name": "Engañar", "attr": "cha" },
        ...
        { "id": "reunir_informacion", "name": "Reunir Información", "attr": "cha" },
        ...
        { "id": "saber_geografia", "name": "Saber (Geografía)", "attr": "int" },
        ...
        { "id": "saber_religion", "name": "Saber (Religión)", "attr": "int" },
        { "id": "saltar", "name": "Saltar", "attr": "str" },
        { "id": "supervivencia", "name": "Supervivencia", "attr": "wis" },
        { "id": "tasacion", "name": "Tasación", "attr": "int" },
        { "id": "trato_con_animales", "name": "Trato con Animales", "attr": "cha" },
        { "id": "trepar", "name": "Trepar", "attr": "str" },
        { "id": "usar_objeto_magico", "name": "Usar Objeto Mágico", "attr": "cha" },
        { "id": "uso_de_cuerdas", "name": "Uso de Cuerdas", "attr": "dex" }
    ],
    "feats": [
        { "name": "Ataque Poderoso", "desc": "Cambia bonificador de ataque por daño cuerpo a cuerpo." },
        ...
        { "name": "Disparo a Bocajarro", "desc": "+1 al ataque y daño con armas a distancia a menos de 30 pies." },
        { "name": "Lanzar Conjuros en Combate", "desc": "+4 a las pruebas de Concentración al lanzar a la defensiva.", "effects": { "skill_concentracion": 4 } },
        { "name": "Gran Fortaleza", "desc": "+2 a las tiradas de Fortaleza.", "effects": { "save_fort": 2 } },
        { "name": "Reflejos Rápidos", "desc": "+2 a las tiradas de Reflejos.", "effects": { "save_ref": 2 } },
        ...
        { "name": "Atlético", "desc": "+2 a Trepar y Nadar.", "effects": { "skill_trepar": 2, "skill_nadar": 2 } },
        ...
        { "name": "Ataque Elástico", "desc": "Puedes moverte antes y después de atacar en cuerpo a cuerpo sin provocar AdO." }
    ],
    "spells": [
        { "name": "Misil Mágico", "level": 1, "school": "Evocación", "desc": "1d4+1 de daño por misil de fuerza. Infalible.", "formula": "1d4+1" },
        { "name": "Curar Heridas Leves", "level": 1, "school": "Conjuración", "desc": "Cura 1d8 + 1/nivel (máx +5).", "formula": "1d8+1" },
        { "name": "Rayo de Escarcha", "level": 0, "school": "Evocación", "desc": "Ataque de toque a distancia, 1d3 daño por frío.", "formula": "1d3" },
        { "name": "Luz", "level": 0, "school": "Evocación", "desc": "El objeto brilla como una antorcha durante 10 min/nivel." },
        { "name": "Armadura de Mago", "level": 1, "school": "Conjuración", "desc": "Te otorga +4 de armadura a la CA por 1 hora/nivel." },
        { "name": "Escudo", "level": 1, "school": "Abjuración", "desc": "Disco de fuerza invisible que otorga +4 CA y bloquea Misiles Mágicos." },
        { "name": "Manos Ardientes", "level": 1, "school": "Evocación", "desc": "Cono de 15 pies de fuego, 1d4 daño/nivel (máx 5d4). Reflejos mitad.", "formula": "1d4" },
        ...
        { "name": "Bendición", "level": 1, "school": "Encantamiento", "desc": "Aliados ganan +1 ataque y salvaciones contra miedo por 1 min/nivel." },
        { "name": "Santuario", "level": 1, "school": "Abjuración", "desc": "Los oponentes deben superar salvación de Voluntad para atacarte." },
        { "name": "Escudo de Fe", "level": 1, "school": "Abjuración", "desc": "Otorga +2 a la CA (desvío) por 1 min/nivel." },
        { "name": "Infligir Heridas Leves", "level": 1, "school": "Nigromancia", "desc": "Toque. Hace 1d8 + 1/nivel de daño (máx +5).", "formula": "1d8+1" },
        { "name": "Curar Heridas Moderadas", "level": 2, "school": "Conjuración", "desc": "Cura 2d8 + 1/nivel (máx +10).", "formula": "2d8+1" },
        { "name": "Flecha Ácida de Melf", "level": 2, "school": "Conjuración", "desc": "Ataque de toque. 2d4 de daño por ácido por 1 asalto + 1/3 niveles.", "formula": "2d4" },
        { "name": "Telaraña", "level": 2, "school": "Conjuración", "desc": "Rellena extensión 20 pies con telarañas pegajosas." },
        { "name": "Invisibilidad", "level": 2, "school": "Ilusión", "desc": "Criatura u objeto se vuelve invisible por 1 min/nivel o hasta que ataque." },
        { "name": "Fuerza de Toro", "level": 2, "school": "Transmutación", "desc": "El objetivo gana +4 de Fuerza durante 1 min/nivel." },
        { "name": "Gracia Felina", "level": 2, "school": "Transmutación", "desc": "El objetivo gana +4 de Destreza durante 1 min/nivel." },
        { "name": "Resistencia de Oso", "level": 2, "school": "Transmutación", "desc": "El objetivo gana +4 de Constitución durante 1 min/nivel." },
        { "name": "Esplendor del Águila", "level": 2, "school": "Transmutación", "desc": "El objetivo gana +4 de Carisma durante 1 min/nivel." },
        { "name": "Astucia de Zorro", "level": 2, "school": "Transmutación", "desc": "El objetivo gana +4 de Inteligencia durante 1 min/nivel." },
        { "name": "Sabiduría de Búho", "level": 2, "school": "Transmutación", "desc": "El objetivo gana +4 de Sabiduría durante 1 min/nivel." },
        { "name": "Bola de Fuego", "level": 3, "school": "Evocación", "desc": "Explosión de 20 pies. 1d6 daño de fuego/nivel (máx 10d6). Reflejos mitad." },
        { "name": "Relámpago", "level": 3, "school": "Evocación", "desc": "Línea de 120 pies. 1d6 daño eléc/nivel (máx 10d6). Reflejos mitad." },
        { "name": "Volar", "level": 3, "school": "Transmutación", "desc": "El objetivo gana velocidad de vuelo 60 pies por 1 min/nivel." },
        { "name": "Acelerar", "level": 3, "school": "Transmutación", "desc": "+1 ataque, CA y Reflejos. Mueves 30 pies más rápido. 1 asalto/nivel." },
        { "name": "Curar Heridas Graves", "level": 3, "school": "Conjuración", "desc": "Cura 3d8 + 1/nivel (máx +15).", "formula": "3d8+1" },
        { "name": "Disipar Magia", "level": 3, "school": "Abjuración", "desc": "Cancela efectos mágicos. Prueba de nivel de lanzador contra CD 11 + nivel del lanzador original." },
        { "name": "Plegaria", "level": 3, "school": "Encantamiento", "desc": "Aliados obtienen +1 Suerte al ataque, CA y salvaciones. Enemigos -1." }
    ]
}

js_output = "const DND_DB = " + json.dumps(db, ensure_ascii=False, indent=4) + ";\n\n// Si itemsdb.js ha cargado items, se asignan aquí\nDND_DB.items = (window.DND_ITEMS) ? window.DND_ITEMS : [];\n"
